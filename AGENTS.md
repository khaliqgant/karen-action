...
<name>using-agent-relay</name>
<description>Skill for coordinating multiple AI agents - enables real-time inter-agent messaging via PTY wrapper or file-based inbox system</description>
<path>.openskills/using-agent-relay/SKILL.md</path>
</skill>
